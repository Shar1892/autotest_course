...
def multiplication_chain(num):
    ...
    while intermediate_result > 9:
        str_intermediate_result = str(intermediate_result)
        intermediate_result = 1
        for i in range(len(str_intermediate_result)):
            intermediate_result *= int(str_intermediate_result[i])
        count_multy += 1
